      ...
      <div className={`app ${isDarkMode ? 'dark-mode' : ''}`}>
        ...
        >
          <div className="container header-content">
            ...
            >
              <h2>New Basant<span>Flower Decoration</span></h2>
            </motion.div>
            ...
            <>
              ...
              <section id="home" className="hero">
                ...
                <div className="container hero-content">
                  <motion.h1 
                    ...
                    style={{ filter: 'blur(1px)', color: 'white' }} 
              ...
              {/* <section className="py-20 bg-gradient-to-r from-dark-blue/10 to-royal-gold/10"> */}
                {/* <div className="container">
                  ...
                  > */}
                  {/* <VideoBackground 
  videoUrl={"/marriage.mp4" }
  fallbackImageUrl={fallbackImageUrl}
/> */}
 {/* <VideoBackground videoUrl={middleVideoUrl} fallbackImageUrl={fallbackImageUrl} /> */}
          ...
          <div className="container">
            <div className="footer-grid">
              <div className="footer-section">
                <div className="footer-logo">New Basant<span>Flower Decoration</span></div>
            ...
            <div className="copyright">
              &copy; 2025 New Basant Flower Decoration. All Rights Reserved.
            </div>
          </div>
        </footer>
